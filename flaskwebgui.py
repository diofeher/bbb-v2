...
class FlaskUI:
    """
        ...
        width=900                         ==> default width 800 
        height=800                        ==> default height 600
    ...
    def __init__(self, app=None, width=800, height=900, fullscreen=False, maximized=False, app_mode=True,  browser_path="", server="flask", host="127.0.0.1", port=5000, socketio=None, on_exit=None):
        self.flask_app = app
